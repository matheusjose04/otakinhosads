...
Este não é um repositório de extensões novas — é só um espelho de correções pontuais sobre o trabalho do [Project Nox](https://github.com/Awerkori/fonte-extensoes) e do [Keiyoushi](https://github.com/keiyoushi/extensions-source). Créditos a ambos pela base técnica e pelas fontes originais.
